...
------------ | ------------- | ------------- | -------------
*AdminOperationsApi* | [**addInventory**](docs/AdminOperationsApi.md#addInventory) | **POST** /inventory | adds an inventory item
*PublicOperationsApi* | [**searchInventory**](docs/PublicOperationsApi.md#searchInventory) | **GET** /inventory | searches inventory
